...
class MQTTManager:
    def __init__(self, broker: str = "localhost", port: int = 1883, team_id: str = "Phoenix_team"):
        self.broker = broker
        self.port = port
    ...
    def publish_movement(self, status: str, confidence: float = 1.0, face_name: Optional[str] = None, angle: int = 90):
        if not self.client:
            return
